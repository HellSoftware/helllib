/*  hell_parser - v0.0.2 - MIT LICENSE
 *
...
/* 
 * This functions goes one by one character in a buffer,
 * looking for delim, if fount 'unsigned count'
 * times in a row:
 * - retrun HELL_PARSER_OK;
 *
 * It leaves last
 * position of parser.pos same when retruning,
 * so you know where it detected delim, and you can
 * keep using same *parser.
 *
 * If not:
 * - return HELL_PARSER_ERROR;
 */
